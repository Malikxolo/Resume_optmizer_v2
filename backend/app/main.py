...
# CORS — allow Next.js frontend on Vercel, production domain, and localhost
settings = get_settings()
app.add_middleware(
    CORSMiddleware,
    allow_origins=[
    ...
    allow_origin_regex=r"https://.*\.vercel\.app|https://resume\.totalcareservices\.me|http://localhost:\d+",
